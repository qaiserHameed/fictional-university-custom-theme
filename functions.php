...
function university_files(){
    ...
    // wp_enqueue_script('search-js',get_theme_file_uri('/js/modules/Search.js'), array('jquery'), '1.0' , true);
...
// function add_module_type_to_search_js($tag, $handle, $src) {
//     if ($handle === 'search-js') {
//         $tag = '<script type="module" src="' . esc_url($src) . '"></script>';
//     }
//     return $tag;
// }
// add_filter('script_loader_tag', 'add_module_type_to_search_js', 10, 3); // Priority 10 for search-js

// function add_module_type_to_main_js($tag, $handle, $src) {
//     if ($handle === 'main-js') {
//         $tag = '<script type="module" src="' . esc_url($src) . '"></script>';
//     }
//     return $tag;
// }
// add_filter('script_loader_tag', 'add_module_type_to_main_js', 20, 3); // Priority 20 for main-js
